    ...
    <div className="bg-gray-50 dark:bg-gray-800 shadow-xl rounded-lg p-6 space-y-4">
      <div className="flex justify-between items-center">
        <div className="flex items-center">
          <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mr-2">Manage Gemini API Key</h2>
          <button 
          ...
          >
            ...
            <span className="sr-only">{isExpanded ? "Collapse API Key Form" : "Expand API Key Form"}</span>
          </button>
        </div>
        {onLogout && (
          <button
